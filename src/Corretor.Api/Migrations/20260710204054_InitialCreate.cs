        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    LeadId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    Identificacao = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Endereco = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Data = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Dependentes = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FaixaEtaria_Lead_LeadId",
                        column: x => x.LeadId,
                        principalTable: "Lead",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PosContrato", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PosContrato_Contrato_ContratoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cliente_LeadId",
                table: "Cliente",
                column: "LeadId");

            migrationBuilder.CreateIndex(
                name: "IX_Contrato_LeadId",
                table: "Contrato",
                column: "LeadId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FaixaEtaria_LeadId",
                table: "FaixaEtaria",
                column: "LeadId");

            migrationBuilder.CreateIndex(
                name: "IX_Historico_LeadId",
                table: "Historico",
                column: "LeadId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PosContrato_ContratoId",
                table: "PosContrato",
                column: "ContratoId");
