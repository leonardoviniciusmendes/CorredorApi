...
namespace Corretor.Api.Migrations
{
    ...
    [Migration("20260716170538_MoveAnaliseToLead")]
    partial class MoveAnaliseToLead
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Corretor.Api.Entities.Dependente", b =>
                {
                    ...
                    b.Property<Guid?>("PessoaFisicaDependenteId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("PessoaFisicaDependenteId");
            ...
            modelBuilder.Entity("Corretor.Api.Entities.Dependente", b =>
                {
                    b.HasOne("Corretor.Api.Entities.PessoaFisica", null)
                        .WithMany()
                        .HasForeignKey("PessoaFisicaDependenteId")
                        .OnDelete(DeleteBehavior.Restrict);
